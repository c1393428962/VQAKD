...
class KD_2(nn.Module):
    ...
    def forward(self, video_appearance_feat, video_motion_feat, question,
        ...
        # Reasoning module
        ## 1. layer-1
        visual_embedding, appearance_video_feat, motion_video_feat, aq_embed, mq_embed, com_app, com_motion, aq_fusion, mq_fusion = self.visual_input_unit(
        ...
        return appearance_video_feat, motion_video_feat, out, aq_embed, mq_embed, com_app, com_motion, aq_fusion, mq_fusion
...
class DualVGRUnit_multiple(nn.Module):  # 16, 8, 1, 2048, 512
    ...
    def forward(self, appearance_video_feat, motion_video_feat, dynamic_question_embedding, word_embedding, question_len):
        ...
        return visual_feature, appearance_video_feat, motion_video_feat, aq_embed, mq_embed, com_app_list, com_motion_list, aq_fusion_list, mq_fusion_list
